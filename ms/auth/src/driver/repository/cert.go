...
func (r CertRepo) CreateScope(ctx context.Context, uid, cid int64, auth string) error {
...
func (r CertRepo) GetScope(ctx context.Context, uid, cid int64) (*entity.Scope, error) {
...
func (r CertRepo) UpdateScope(ctx context.Context, uid, cid int64, auth string) error {
	if err := r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
...
func (r CertRepo) DeleteScope(ctx context.Context, uid, cid int64) error {
	if err := r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
